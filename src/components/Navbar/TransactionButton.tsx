	...
	return (
		<div className="rounded-lg">
			...
			<dialog
				ref={dialogRef}
				onClick={close}
				className={`text-slate-300 text-center p-6 rounded-lg bg-background-1 shadow-md ${shadowBackgroundClass} max-w-md top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2`}
			>
				<label htmlFor="amount">{capitalizeFirstLetter(type)} Amount (USDC)</label>
				<input className="text-center my-5 " ref={inputRef} type="number" id="amount" name="amount" min="1" defaultValue="1000" placeholder="Amount" required></input>
